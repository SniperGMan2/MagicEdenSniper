...
const Header = () => {
    ...
    const inputDom = useRef<HTMLDivElement>(null);
    ...
    useEffect(() => {
        ...
        return () => window.removeEventListener('keydown', keyDownE);
    }, []);
        ...
        <div className='container flex items-center justify-between py-2 mx-auto'>
            ...
            <div className='flex items-center gap-3'>
                <div className='relative flex items-center gap-3'>
                    <div>Search:</div>
                    <input value={query} onChange={onChange} onKeyDown={onKeyDown} type='text' placeholder='Search collections..' className='px-3 py-1 bg-transparent border rounded-md outline-none w-96 focus:border-green-600 caret-green-600' />
