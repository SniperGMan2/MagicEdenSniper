...
const Collection = () => {
    ...
    const [collection , setCollection] = useState<col>({floor_price:0});
    const [items, setItems] = useState([]);
    const [filter, setFilter] = useState({price_range:{currency:'sol'} as priceRange ,rarity_range: {} as rarityRange ,traits:{}, listing_status: [] as number[] });
    ...
    return (
        <div className='container flex min-h-screen gap-5 pb-5 mx-auto mt-10'>
            ...
            <div className='flex-1'>
                ...
                <InfiniteScroll dataLength={items.length} next={fetch} hasMore={hasMore} className='grid grid-cols-4 gap-5' loader={undefined}>
